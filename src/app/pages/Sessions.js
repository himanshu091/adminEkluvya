...
import { fetchTeachers, createClass, createTeacher, fetchSessions } from '../../api'
...
function Sessions() {
    ...
    const handleSubmit = async () =>{
      ...
      const res = await createTeacher(nameQ.current.value, emailQ.current.value, passwordQ.current.value, mobQ.current.value, subjectQ.current.value)
      console.log(res)
      setshowForm(false)
      fetchAllSessions()
          ...
          <div className="overlay overlay-block cursor-default modal-body">
            <form action="#" className="form form-label-right">
              <div className="form-group row">
                ...
                <div className="col-lg-6">
                  <label>Mobile</label><input type="text" ref={mobQ} className="form-control" name="mob" placeholder="Enter Mobile"  />
                  {/* <div className="feedback">Please enter <b>Per Session Cost</b></div> */}
                </div>
                <div className="col-lg-6">
                  <label>Subject</label><input type="text" ref={subjectQ} className="form-control" name="subject" placeholder="Enter Subject"  />
                  {/* <div className="feedback">Please enter <b>Per Session Cost</b></div> */}
                </div>
              </div>
